<section class="relative bg-accent-dark py-32 overflow-hidden">
	...
	<div class="absolute inset-0 bg-gradient-to-b from-accent-dark via-transparent to-accent-dark"></div>
	...
	<div class="relative z-10 mx-auto max-w-[1400px] px-6">
		...
		<div class="mx-auto max-w-2xl overflow-hidden rounded-lg bg-white shadow-2xl">
			<div class="border-b border-gray-100 bg-bg-light px-4 py-3">
			...
			<div class="relative flex items-center p-2">
				<input
					type="text"
					value="62 y/o male presenting with chest pain, onset 2 hours ago, radiating to left arm..."
					class="w-full border-none bg-transparent px-2 py-3 text-navy placeholder-gray-400 focus:ring-0 text-sm"
					readonly
				/>
				<button class="ml-2 rounded bg-primary-500 p-2 text-white hover:bg-primary-600">
