		...
		<div class="mx-auto max-w-2xl overflow-hidden rounded-lg bg-white shadow-2xl">
			<div class="border-b border-gray-100 bg-gray-50/50 px-4 py-3">
				<div class="flex items-center gap-2 text-sm text-gray-500">
					<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-primary-600"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/></svg>
					Ambient AI Note
				</div>
			</div>
			<div class="relative flex items-center p-2">
				<input 
					...
					readonly
				/>
				<button class="ml-2 rounded bg-primary-600 p-2 text-white hover:bg-primary-700">
